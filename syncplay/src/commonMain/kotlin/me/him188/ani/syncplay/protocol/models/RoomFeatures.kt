 ...
 *
 * Apply only to fields that decode untrusted inbound JSON (`ListUserData`, `SetData`,
 * `HelloData` in `me.him188.ani.syncplay.protocol.wire`). The class itself stays a
